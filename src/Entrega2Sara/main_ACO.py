...
Matriz_longitud_tours = np.zeros((iterMax,2))

# incumbente inicial: valor infinito (minimización)
incumbente:float = 1000000000000 #Como es un problema de minimización arrranco con uno grande para irlo reduciendo
...
#    
#    # Verificar si hay mejoramiento de la incumbente y actualizo
